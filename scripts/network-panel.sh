...
INFO+="<span fgcolor='White'> ${RX}</span>"
INFO+=" |"
INFO+="<span fgcolor='White'> ${TX}</span> KB/s"
INFO+="</txt>"
# Tooltip
MORE_INFO="<tool>"
MORE_INFO+="${TOOLTIP}"
